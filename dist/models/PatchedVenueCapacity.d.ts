...
export declare function PatchedVenueCapacityToJSONTyped(value?: Omit<PatchedVenueCapacity, 'id' | 'created_at' | 'updated_at' | 'archive_at' | 'tenant' | 'created_by' | 'updated_by' | 'venue'> | null, ignoreDiscriminator?: boolean): any;
