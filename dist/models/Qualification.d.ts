...
export declare function QualificationToJSONTyped(value?: Omit<Qualification, 'id' | 'created_at' | 'updated_at' | 'tenant_id' | 'created_by'> | null, ignoreDiscriminator?: boolean): any;
