...
function instanceOfExpense(value) {
    if (!('id' in value) || value['id'] === undefined)
        return false;
    if (!('purchaserName' in value) || value['purchaserName'] === undefined)
        return false;
    if (!('approverName' in value) || value['approverName'] === undefined)
        return false;
    if (!('vendorName' in value) || value['vendorName'] === undefined)
        return false;
    ...
    if (!('productionName' in value) || value['productionName'] === undefined)
        return false;
    if (!('attachmentsCount' in value) || value['attachmentsCount'] === undefined)
        return false;
    if (!('reimbursedAmount' in value) || value['reimbursedAmount'] === undefined)
        return false;
    if (!('pendingReimbursementAmount' in value) || value['pendingReimbursementAmount'] === undefined)
        return false;
