...
export declare function PatchedVenueToJSONTyped(value?: Omit<PatchedVenue, 'id' | 'created_at' | 'updated_at' | 'tenant_id' | 'created_by'> | null, ignoreDiscriminator?: boolean): any;
