...
export declare function PatchedIncomeToJSONTyped(value?: Omit<PatchedIncome, 'id' | 'category_name' | 'prod_category_name' | 'production_id' | 'production_name' | 'created_at' | 'updated_at' | 'archive_at' | 'tenant' | 'created_by' | 'updated_by'> | null, ignoreDiscriminator?: boolean): any;
