...
export declare function EmployeeQualificationToJSONTyped(value?: Omit<EmployeeQualification, 'id' | 'created_at' | 'updated_at'> | null, ignoreDiscriminator?: boolean): any;
