...
export declare function EmployeeQualificationToJSONTyped(value?: Omit<EmployeeQualification, 'id' | 'created_at' | 'updated_at' | 'tenant_id' | 'created_by'> | null, ignoreDiscriminator?: boolean): any;
