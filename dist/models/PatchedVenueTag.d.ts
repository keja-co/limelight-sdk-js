...
export declare function PatchedVenueTagToJSONTyped(value?: Omit<PatchedVenueTag, 'id' | 'created_at' | 'updated_at' | 'tenant_id' | 'created_by'> | null, ignoreDiscriminator?: boolean): any;
