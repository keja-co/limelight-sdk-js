...
function instanceOfIncome(value) {
    ...
    if (!('categoryName' in value) || value['categoryName'] === undefined)
        return false;
    if (!('prodCategoryName' in value) || value['prodCategoryName'] === undefined)
        return false;
...
function IncomeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'prodCategoryName': json['prod_category_name'],
...
function IncomeToJSONTyped(value, ignoreDiscriminator) {
    ...
    return {
        ...
        'amount': value['amount'],
        'income_date': value['incomeDate'] == null ? value['incomeDate'] : value['incomeDate'].toISOString().substring(0, 10),
