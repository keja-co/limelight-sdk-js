...
export declare function WorkLocationToJSONTyped(value?: Omit<WorkLocation, 'id' | 'created_at' | 'updated_at' | 'tenant_id' | 'created_by'> | null, ignoreDiscriminator?: boolean): any;
