...
export declare function PatchedWorkLocationToJSONTyped(value?: Omit<PatchedWorkLocation, 'id' | 'created_at' | 'updated_at' | 'tenant_id' | 'created_by'> | null, ignoreDiscriminator?: boolean): any;
