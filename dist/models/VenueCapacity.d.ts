...
export declare function VenueCapacityToJSONTyped(value?: Omit<VenueCapacity, 'id' | 'created_at' | 'updated_at' | 'tenant_id' | 'created_by'> | null, ignoreDiscriminator?: boolean): any;
