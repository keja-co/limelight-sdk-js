...
export declare function PatchedQualificationToJSONTyped(value?: Omit<PatchedQualification, 'id' | 'created_at' | 'updated_at' | 'tenant_id' | 'created_by'> | null, ignoreDiscriminator?: boolean): any;
