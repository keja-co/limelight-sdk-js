...
function EmployeeToJSONTyped(value, ignoreDiscriminator) {
    ...
    return {
        ...
        'hire_date': value['hireDate'] == null ? value['hireDate'] : value['hireDate'].toISOString().substring(0, 10),
        ...
        'probation_end_date': value['probationEndDate'] == null ? value['probationEndDate'] : value['probationEndDate'].toISOString().substring(0, 10),
        'notes': value['notes'],
        'user': value['user'],
