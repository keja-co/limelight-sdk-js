...
exports.PaginatedRoleListToJSONTyped = PaginatedRoleListToJSONTyped;
...
function PaginatedRoleListToJSON(json) {
    return PaginatedRoleListToJSONTyped(json, false);
}
function PaginatedRoleListToJSONTyped(value, ignoreDiscriminator) {
