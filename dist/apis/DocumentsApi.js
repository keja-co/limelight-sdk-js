...
var DocumentsApi = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    case 0:
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposCreate().');
                        }
                        ...
                        urlPath = "/api/t/{tenant_ref}/documents/v1/repos/";
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposDestroy().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        urlPath = "/api/t/{tenant_ref}/documents/v1/repos/{id}/";
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposDocumentsCreate().');
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposDocumentsDestroy().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        urlPath = "/api/t/{tenant_ref}/documents/v1/repos/{repo_id}/documents/{id}/";
                        urlPath = urlPath.replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters['id'])));
                        urlPath = urlPath.replace("{".concat("repo_id", "}"), encodeURIComponent(String(requestParameters['repoId'])));
                        urlPath = urlPath.replace("{".concat("tenant_ref", "}"), encodeURIComponent(String(requestParameters['tenantRef'])));
                        return [4 /*yield*/, this.request({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposDocumentsList().');
                        }
                        queryParameters = {};
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposDocumentsPartialUpdate().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposDocumentsRetrieve().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        urlPath = "/api/t/{tenant_ref}/documents/v1/repos/{repo_id}/documents/{id}/";
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
                        urlPath = "/api/t/{tenant_ref}/documents/v1/repos/{repo_id}/documents/{document_id}/tags/";
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposDocumentsTagsDestroy().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        urlPath = "/api/t/{tenant_ref}/documents/v1/repos/{repo_id}/documents/{document_id}/tags/{id}/";
                        urlPath = urlPath.replace("{".concat("document_id", "}"), encodeURIComponent(String(requestParameters['documentId'])));
                        urlPath = urlPath.replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters['id'])));
                        urlPath = urlPath.replace("{".concat("repo_id", "}"), encodeURIComponent(String(requestParameters['repoId'])));
                        urlPath = urlPath.replace("{".concat("tenant_ref", "}"), encodeURIComponent(String(requestParameters['tenantRef'])));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposDocumentsTagsList().');
                        }
                        queryParameters = {};
                        if (requestParameters['page'] != null) {
                            queryParameters['page'] = requestParameters['page'];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposDocumentsTagsRetrieve().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        urlPath = "/api/t/{tenant_ref}/documents/v1/repos/{repo_id}/documents/{document_id}/tags/{id}/";
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposDocumentsUpdate().');
                        }
                        if (requestParameters['document'] == null) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposDocumentsVersionsCreate().');
                        }
                        ...
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
                        urlPath = "/api/t/{tenant_ref}/documents/v1/repos/{repo_id}/documents/{document_id}/versions/";
                        urlPath = urlPath.replace("{".concat("document_id", "}"), encodeURIComponent(String(requestParameters['documentId'])));
                        urlPath = urlPath.replace("{".concat("repo_id", "}"), encodeURIComponent(String(requestParameters['repoId'])));
                        urlPath = urlPath.replace("{".concat("tenant_ref", "}"), encodeURIComponent(String(requestParameters['tenantRef'])));
                        return [4 /*yield*/, this.request({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposDocumentsVersionsDestroy().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        urlPath = "/api/t/{tenant_ref}/documents/v1/repos/{repo_id}/documents/{document_id}/versions/{id}/";
                        urlPath = urlPath.replace("{".concat("document_id", "}"), encodeURIComponent(String(requestParameters['documentId'])));
                        urlPath = urlPath.replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters['id'])));
                        urlPath = urlPath.replace("{".concat("repo_id", "}"), encodeURIComponent(String(requestParameters['repoId'])));
                        urlPath = urlPath.replace("{".concat("tenant_ref", "}"), encodeURIComponent(String(requestParameters['tenantRef'])));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposDocumentsVersionsList().');
                        }
                        queryParameters = {};
                        if (requestParameters['page'] != null) {
                            queryParameters['page'] = requestParameters['page'];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposDocumentsVersionsPartialUpdate().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposDocumentsVersionsRetrieve().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        urlPath = "/api/t/{tenant_ref}/documents/v1/repos/{repo_id}/documents/{document_id}/versions/{id}/";
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposDocumentsVersionsUpdate().');
                        }
                        if (requestParameters['documentVersion'] == null) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposFoldersCreate().');
                        }
                        ...
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
                        urlPath = "/api/t/{tenant_ref}/documents/v1/repos/{repo_id}/folders/";
                        urlPath = urlPath.replace("{".concat("repo_id", "}"), encodeURIComponent(String(requestParameters['repoId'])));
                        urlPath = urlPath.replace("{".concat("tenant_ref", "}"), encodeURIComponent(String(requestParameters['tenantRef'])));
                        return [4 /*yield*/, this.request({
                                path: urlPath,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposFoldersDestroy().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        urlPath = "/api/t/{tenant_ref}/documents/v1/repos/{repo_id}/folders/{id}/";
                        urlPath = urlPath.replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters['id'])));
                        urlPath = urlPath.replace("{".concat("repo_id", "}"), encodeURIComponent(String(requestParameters['repoId'])));
                        urlPath = urlPath.replace("{".concat("tenant_ref", "}"), encodeURIComponent(String(requestParameters['tenantRef'])));
                        return [4 /*yield*/, this.request({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposFoldersList().');
                        }
                        queryParameters = {};
                        if (requestParameters['page'] != null) {
                            queryParameters['page'] = requestParameters['page'];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposFoldersPartialUpdate().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposFoldersRetrieve().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        urlPath = "/api/t/{tenant_ref}/documents/v1/repos/{repo_id}/folders/{id}/";
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposFoldersUpdate().');
                        }
                        if (requestParameters['folder'] == null) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposList().');
                        }
                        queryParameters = {};
                        if (requestParameters['page'] != null) {
                            queryParameters['page'] = requestParameters['page'];
     ...
     * List all document repositories
     */
    DocumentsApi.prototype.documentsV1ReposList = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposPartialUpdate().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposRetrieve().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        urlPath = "/api/t/{tenant_ref}/documents/v1/repos/{id}/";
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1ReposUpdate().');
                        }
                        if (requestParameters['documentRepo'] == null) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1TagsCreate().');
                        }
                        ...
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
                        urlPath = "/api/t/{tenant_ref}/documents/v1/tags/";
                        urlPath = urlPath.replace("{".concat("tenant_ref", "}"), encodeURIComponent(String(requestParameters['tenantRef'])));
                        return [4 /*yield*/, this.request({
                                path: urlPath,
                                method: 'POST',
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1TagsDestroy().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        urlPath = "/api/t/{tenant_ref}/documents/v1/tags/{id}/";
                        urlPath = urlPath.replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters['id'])));
                        urlPath = urlPath.replace("{".concat("tenant_ref", "}"), encodeURIComponent(String(requestParameters['tenantRef'])));
                        return [4 /*yield*/, this.request({
                                path: urlPath,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1TagsList().');
                        }
                        queryParameters = {};
                        if (requestParameters['page'] != null) {
                            queryParameters['page'] = requestParameters['page'];
     ...
     * List all tags
     */
    DocumentsApi.prototype.documentsV1TagsList = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1TagsPartialUpdate().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1TagsRetrieve().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        urlPath = "/api/t/{tenant_ref}/documents/v1/tags/{id}/";
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling documentsV1TagsUpdate().');
                        }
                        if (requestParameters['tag'] == null) {
