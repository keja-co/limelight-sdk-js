...
export declare class BudgetingApi extends runtime.BaseAPI {
     ...
     */
    budgetingV1ProductionsSummaryListRaw(requestParameters: BudgetingV1ProductionsSummaryListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginatedProductionBudgetSummaryList>>;
    /**
     * Return budget totals and annotated breakdowns for a production.
     * Production budget summary
     */
    budgetingV1ProductionsSummaryList(requestParameters: BudgetingV1ProductionsSummaryListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PaginatedProductionBudgetSummaryList>;
    /**
