...
exports.ProductionV1ProductionsRolesListRoleEnum = exports.ProductionV1ProductionsMembersRolesListRoleEnum = exports.ProductionApi = void 0;
...
var ProductionApi = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['endDateLte'] != null) {
                            queryParameters['end_date_lte'] = requestParameters['endDateLte'].toISOString();
                        }
                        ...
                        if (requestParameters['startDateGte'] != null) {
                            queryParameters['start_date_gte'] = requestParameters['startDateGte'].toISOString();
                        }
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.PaginatedProductionListListFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Create a Production Role Assignment
     */
    ProductionApi.prototype.productionV1ProductionsRolesCreateRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, urlPath, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters['memberId'] == null) {
                            throw new runtime.RequiredError('memberId', 'Required parameter "memberId" was null or undefined when calling productionV1ProductionsRolesCreate().');
                        }
                        if (requestParameters['productionId'] == null) {
                            throw new runtime.RequiredError('productionId', 'Required parameter "productionId" was null or undefined when calling productionV1ProductionsRolesCreate().');
                        }
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling productionV1ProductionsRolesCreate().');
                        }
                        if (requestParameters['productionRoleAssignment'] == null) {
                            throw new runtime.RequiredError('productionRoleAssignment', 'Required parameter "productionRoleAssignment" was null or undefined when calling productionV1ProductionsRolesCreate().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
                        urlPath = "/api/t/{tenant_ref}/production/v1/productions/{production_id}/roles/";
                        urlPath = urlPath.replace("{".concat("member_id", "}"), encodeURIComponent(String(requestParameters['memberId'])));
                        urlPath = urlPath.replace("{".concat("production_id", "}"), encodeURIComponent(String(requestParameters['productionId'])));
                        urlPath = urlPath.replace("{".concat("tenant_ref", "}"), encodeURIComponent(String(requestParameters['tenantRef'])));
                        return [4 /*yield*/, this.request({
     ...
     * Create a Production Role Assignment
     */
    ProductionApi.prototype.productionV1ProductionsRolesCreate = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productionV1ProductionsRolesCreateRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     * Delete a Production Role Assignment
     */
    ProductionApi.prototype.productionV1ProductionsRolesDestroyRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, urlPath, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters['id'] == null) {
                            throw new runtime.RequiredError('id', 'Required parameter "id" was null or undefined when calling productionV1ProductionsRolesDestroy().');
                        }
                        if (requestParameters['memberId'] == null) {
                            throw new runtime.RequiredError('memberId', 'Required parameter "memberId" was null or undefined when calling productionV1ProductionsRolesDestroy().');
                        }
                        if (requestParameters['productionId'] == null) {
                            throw new runtime.RequiredError('productionId', 'Required parameter "productionId" was null or undefined when calling productionV1ProductionsRolesDestroy().');
                        }
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling productionV1ProductionsRolesDestroy().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        urlPath = "/api/t/{tenant_ref}/production/v1/productions/{production_id}/roles/{id}/";
                        urlPath = urlPath.replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters['id'])));
                        urlPath = urlPath.replace("{".concat("member_id", "}"), encodeURIComponent(String(requestParameters['memberId'])));
                        urlPath = urlPath.replace("{".concat("production_id", "}"), encodeURIComponent(String(requestParameters['productionId'])));
                        urlPath = urlPath.replace("{".concat("tenant_ref", "}"), encodeURIComponent(String(requestParameters['tenantRef'])));
     ...
     * Delete a Production Role Assignment
     */
    ProductionApi.prototype.productionV1ProductionsRolesDestroy = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productionV1ProductionsRolesDestroyRaw(requestParameters, initOverrides)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     */
    ProductionApi.prototype.productionV1ProductionsRolesListRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, urlPath, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters['memberId'] == null) {
                            throw new runtime.RequiredError('memberId', 'Required parameter "memberId" was null or undefined when calling productionV1ProductionsRolesList().');
                        }
                        if (requestParameters['productionId'] == null) {
                            throw new runtime.RequiredError('productionId', 'Required parameter "productionId" was null or undefined when calling productionV1ProductionsRolesList().');
                        }
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling productionV1ProductionsRolesList().');
                        }
                        queryParameters = {};
                        if (requestParameters['page'] != null) {
                            queryParameters['page'] = requestParameters['page'];
     ...
     * List Production Role Assignments (by production)
     */
    ProductionApi.prototype.productionV1ProductionsRolesList = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productionV1ProductionsRolesListRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     * Partially Update a Production Role Assignment
     */
    ProductionApi.prototype.productionV1ProductionsRolesPartialUpdateRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, urlPath, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters['id'] == null) {
                            throw new runtime.RequiredError('id', 'Required parameter "id" was null or undefined when calling productionV1ProductionsRolesPartialUpdate().');
                        }
                        if (requestParameters['memberId'] == null) {
                            throw new runtime.RequiredError('memberId', 'Required parameter "memberId" was null or undefined when calling productionV1ProductionsRolesPartialUpdate().');
                        }
                        if (requestParameters['productionId'] == null) {
                            throw new runtime.RequiredError('productionId', 'Required parameter "productionId" was null or undefined when calling productionV1ProductionsRolesPartialUpdate().');
                        }
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling productionV1ProductionsRolesPartialUpdate().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
     ...
     * Partially Update a Production Role Assignment
     */
    ProductionApi.prototype.productionV1ProductionsRolesPartialUpdate = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productionV1ProductionsRolesPartialUpdateRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     * Retrieve a Production Role Assignment
     */
    ProductionApi.prototype.productionV1ProductionsRolesRetrieveRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, urlPath, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters['id'] == null) {
                            throw new runtime.RequiredError('id', 'Required parameter "id" was null or undefined when calling productionV1ProductionsRolesRetrieve().');
                        }
                        if (requestParameters['memberId'] == null) {
                            throw new runtime.RequiredError('memberId', 'Required parameter "memberId" was null or undefined when calling productionV1ProductionsRolesRetrieve().');
                        }
                        if (requestParameters['productionId'] == null) {
                            throw new runtime.RequiredError('productionId', 'Required parameter "productionId" was null or undefined when calling productionV1ProductionsRolesRetrieve().');
                        }
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling productionV1ProductionsRolesRetrieve().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        urlPath = "/api/t/{tenant_ref}/production/v1/productions/{production_id}/roles/{id}/";
     ...
     * Retrieve a Production Role Assignment
     */
    ProductionApi.prototype.productionV1ProductionsRolesRetrieve = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productionV1ProductionsRolesRetrieveRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     * Update a Production Role Assignment
     */
    ProductionApi.prototype.productionV1ProductionsRolesUpdateRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, urlPath, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters['id'] == null) {
                            throw new runtime.RequiredError('id', 'Required parameter "id" was null or undefined when calling productionV1ProductionsRolesUpdate().');
                        }
                        if (requestParameters['memberId'] == null) {
                            throw new runtime.RequiredError('memberId', 'Required parameter "memberId" was null or undefined when calling productionV1ProductionsRolesUpdate().');
                        }
                        if (requestParameters['productionId'] == null) {
                            throw new runtime.RequiredError('productionId', 'Required parameter "productionId" was null or undefined when calling productionV1ProductionsRolesUpdate().');
                        }
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling productionV1ProductionsRolesUpdate().');
                        }
                        if (requestParameters['productionRoleAssignment'] == null) {
                            throw new runtime.RequiredError('productionRoleAssignment', 'Required parameter "productionRoleAssignment" was null or undefined when calling productionV1ProductionsRolesUpdate().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
     ...
     * Update a Production Role Assignment
     */
    ProductionApi.prototype.productionV1ProductionsRolesUpdate = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productionV1ProductionsRolesUpdateRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
 ...
 * @export
 */
exports.ProductionV1ProductionsMembersRolesListRoleEnum = {
    Actor: 'actor',
 ...
 * @export
 */
exports.ProductionV1ProductionsRolesListRoleEnum = {
    Actor: 'actor',
    AssistantChoreographer: 'assistant_choreographer',
    AssistantCostumeDesigner: 'assistant_costume_designer',
    AssistantDirector: 'assistant_director',
