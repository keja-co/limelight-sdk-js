...
var FormsApi = /** @class */ (function (_super) {
     ...
     */
    FormsApi.prototype.formsV1FormsSubmissionsByMemberRetrieveRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, urlPath, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters['member'] == null) {
                            throw new runtime.RequiredError('member', 'Required parameter "member" was null or undefined when calling formsV1FormsSubmissionsByMemberRetrieve().');
                        }
                        if (requestParameters['tenantRef'] == null) {
                            throw new runtime.RequiredError('tenantRef', 'Required parameter "tenantRef" was null or undefined when calling formsV1FormsSubmissionsByMemberRetrieve().');
                        }
                        queryParameters = {};
                        if (requestParameters['member'] != null) {
                        ...
                        headerParameters = {};
                        urlPath = "/api/t/{tenant_ref}/forms/v1/forms/submissions-by-member/";
                        urlPath = urlPath.replace("{".concat("tenant_ref", "}"), encodeURIComponent(String(requestParameters['tenantRef'])));
                        return [4 /*yield*/, this.request({
                                path: urlPath,
                                method: 'GET',
     ...
     * List submissions by member
     */
    FormsApi.prototype.formsV1FormsSubmissionsByMemberRetrieve = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.formsV1FormsSubmissionsByMemberRetrieveRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
