...
import type {
  ...
  PaginatedIncomeList,
  PaginatedProductionBudgetSummaryList,
...
import {
    ...
    PaginatedProductionBudgetSummaryListFromJSON,
    PaginatedProductionBudgetSummaryListToJSON,
...
export interface BudgetingV1CostCategoriesCreateRequest {
    tenantRef: string;
    costCategory: Omit<CostCategory, 'id'|'parent_name'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'>;
}
...
export interface BudgetingV1CostCategoriesPartialUpdateRequest {
    id: number;
    tenantRef: string;
    patchedCostCategory?: Omit<PatchedCostCategory, 'id'|'parent_name'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'>;
}
...
export interface BudgetingV1ExpensesAttachmentsCreateRequest {
    expenseId: number;
    tenantRef: string;
    expenseAttachment: Omit<ExpenseAttachment, 'id'|'uploaded_by_name'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'>;
}
...
export interface BudgetingV1ExpensesAttachmentsPartialUpdateRequest {
    ...
    id: number;
    tenantRef: string;
    patchedExpenseAttachment?: Omit<PatchedExpenseAttachment, 'id'|'uploaded_by_name'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'>;
}
...
export interface BudgetingV1ExpensesCreateRequest {
    tenantRef: string;
    expense: Omit<Expense, 'id'|'purchaser_name'|'approver_name'|'vendor_name'|'category_name'|'prod_category_name'|'production_id'|'production_name'|'attachments_count'|'reimbursed_amount'|'pending_reimbursement_amount'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'>;
}
...
export interface BudgetingV1ExpensesListRequest {
    ...
    approver?: number;
    category?: number;
    expenseDateTimeGte?: Date;
    expenseDateTimeLte?: Date;
    page?: number;
    pageSize?: number;
...
export interface BudgetingV1ExpensesPartialUpdateRequest {
    id: number;
    tenantRef: string;
    patchedExpense?: Omit<PatchedExpense, 'id'|'purchaser_name'|'approver_name'|'vendor_name'|'category_name'|'prod_category_name'|'production_id'|'production_name'|'attachments_count'|'reimbursed_amount'|'pending_reimbursement_amount'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'>;
}
...
export interface BudgetingV1IncomeCategoriesCreateRequest {
    tenantRef: string;
    incomeCategory: Omit<IncomeCategory, 'id'|'parent_name'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'>;
}
...
export interface BudgetingV1IncomeCategoriesPartialUpdateRequest {
    id: number;
    tenantRef: string;
    patchedIncomeCategory?: Omit<PatchedIncomeCategory, 'id'|'parent_name'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'>;
}
...
export interface BudgetingV1IncomesCreateRequest {
    tenantRef: string;
    income: Omit<Income, 'id'|'category_name'|'prod_category_name'|'production_id'|'production_name'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'>;
}
...
export interface BudgetingV1IncomesPartialUpdateRequest {
    id: number;
    tenantRef: string;
    patchedIncome?: Omit<PatchedIncome, 'id'|'category_name'|'prod_category_name'|'production_id'|'production_name'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'>;
}
...
export interface BudgetingV1ProductionsCostCategoriesCreateRequest {
    productionId: number;
    tenantRef: string;
    productionCostCategory: Omit<ProductionCostCategory, 'id'|'production_name'|'company_cost_category_name'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'>;
}
...
export interface BudgetingV1ProductionsCostCategoriesPartialUpdateRequest {
    ...
    productionId: number;
    tenantRef: string;
    patchedProductionCostCategory?: Omit<PatchedProductionCostCategory, 'id'|'production_name'|'company_cost_category_name'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'>;
}
...
export interface BudgetingV1ProductionsIncomeCategoriesCreateRequest {
    productionId: number;
    tenantRef: string;
    productionIncomeCategory: Omit<ProductionIncomeCategory, 'id'|'production_name'|'income_category_name'|'income_type_label'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'>;
}
...
export interface BudgetingV1ProductionsIncomeCategoriesPartialUpdateRequest {
    ...
    productionId: number;
    tenantRef: string;
    patchedProductionIncomeCategory?: Omit<PatchedProductionIncomeCategory, 'id'|'production_name'|'income_category_name'|'income_type_label'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'>;
}
...
export interface BudgetingV1ProductionsSummaryListRequest {
    productionId: number;
    tenantRef: string;
    page?: number;
    pageSize?: number;
...
export interface BudgetingV1ReimbursementsCreateRequest {
    tenantRef: string;
    reimbursement: Omit<Reimbursement, 'id'|'payee_name'|'approver_name'|'expense_title'|'expense_is_production'|'production_id'|'production_name'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'>;
}
...
export interface BudgetingV1ReimbursementsListRequest {
    ...
    pageSize?: number;
    payee?: number;
    processedDateGte?: Date;
    processedDateLte?: Date;
    production?: number;
...
export interface BudgetingV1ReimbursementsPartialUpdateRequest {
    id: number;
    tenantRef: string;
    patchedReimbursement?: Omit<PatchedReimbursement, 'id'|'payee_name'|'approver_name'|'expense_title'|'expense_is_production'|'production_id'|'production_name'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'>;
}
...
export class BudgetingApi extends runtime.BaseAPI {
    ...
    async budgetingV1ExpensesListRaw(requestParameters: BudgetingV1ExpensesListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginatedExpenseList>> {
        ...
        if (requestParameters['expenseDateTimeGte'] != null) {
            queryParameters['expense_date_time_gte'] = (requestParameters['expenseDateTimeGte'] as any).toISOString();
        }

        if (requestParameters['expenseDateTimeLte'] != null) {
            queryParameters['expense_date_time_lte'] = (requestParameters['expenseDateTimeLte'] as any).toISOString();
        }
    ...
    async budgetingV1IncomesListRaw(requestParameters: BudgetingV1IncomesListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginatedIncomeList>> {
        ...
        if (requestParameters['incomeDateGte'] != null) {
            queryParameters['income_date_gte'] = (requestParameters['incomeDateGte'] as any).toISOString().substring(0,10);
        }

        if (requestParameters['incomeDateLte'] != null) {
            queryParameters['income_date_lte'] = (requestParameters['incomeDateLte'] as any).toISOString().substring(0,10);
        }
     ...
     */
    async budgetingV1ProductionsSummaryListRaw(requestParameters: BudgetingV1ProductionsSummaryListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginatedProductionBudgetSummaryList>> {
        if (requestParameters['productionId'] == null) {
            throw new runtime.RequiredError(
                'productionId',
                'Required parameter "productionId" was null or undefined when calling budgetingV1ProductionsSummaryList().'
            );
        }
        ...
        if (requestParameters['tenantRef'] == null) {
            throw new runtime.RequiredError(
                'tenantRef',
                'Required parameter "tenantRef" was null or undefined when calling budgetingV1ProductionsSummaryList().'
            );
        }
        ...
        let urlPath = `/api/t/{tenant_ref}/budgeting/v1/productions/{production_id}/summary/`;
        urlPath = urlPath.replace(`{${"production_id"}}`, encodeURIComponent(String(requestParameters['productionId'])));
        urlPath = urlPath.replace(`{${"tenant_ref"}}`, encodeURIComponent(String(requestParameters['tenantRef'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PaginatedProductionBudgetSummaryListFromJSON(jsonValue));
    }
     ...
     * Production budget summary
     */
    async budgetingV1ProductionsSummaryList(requestParameters: BudgetingV1ProductionsSummaryListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PaginatedProductionBudgetSummaryList> {
        const response = await this.budgetingV1ProductionsSummaryListRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async budgetingV1ReimbursementsListRaw(requestParameters: BudgetingV1ReimbursementsListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginatedReimbursementList>> {
        ...
        if (requestParameters['processedDateGte'] != null) {
            queryParameters['processed_date_gte'] = (requestParameters['processedDateGte'] as any).toISOString().substring(0,10);
        }

        if (requestParameters['processedDateLte'] != null) {
            queryParameters['processed_date_lte'] = (requestParameters['processedDateLte'] as any).toISOString().substring(0,10);
        }
        ...
        if (requestParameters['scheduledDateGte'] != null) {
            queryParameters['scheduled_date_gte'] = (requestParameters['scheduledDateGte'] as any).toISOString().substring(0,10);
        }

        if (requestParameters['scheduledDateLte'] != null) {
            queryParameters['scheduled_date_lte'] = (requestParameters['scheduledDateLte'] as any).toISOString().substring(0,10);
        }
