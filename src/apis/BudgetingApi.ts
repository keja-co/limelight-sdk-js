...
export interface BudgetingV1ProductionsSummaryRetrieveRequest {
    productionId: number;
    tenantRef: string;
}
...
export class BudgetingApi extends runtime.BaseAPI {
     ...
     */
    async budgetingV1ProductionsSummaryRetrieveRaw(requestParameters: BudgetingV1ProductionsSummaryRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: any; }>> {
        if (requestParameters['productionId'] == null) {
            throw new runtime.RequiredError(
                'productionId',
                'Required parameter "productionId" was null or undefined when calling budgetingV1ProductionsSummaryRetrieve().'
            );
        }
        ...
        if (requestParameters['tenantRef'] == null) {
            throw new runtime.RequiredError(
                'tenantRef',
                'Required parameter "tenantRef" was null or undefined when calling budgetingV1ProductionsSummaryRetrieve().'
            );
        }
     ...
     * Production budget summary
     */
    async budgetingV1ProductionsSummaryRetrieve(requestParameters: BudgetingV1ProductionsSummaryRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: any; }> {
        const response = await this.budgetingV1ProductionsSummaryRetrieveRaw(requestParameters, initOverrides);
        return await response.value();
    }
