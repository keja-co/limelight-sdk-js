...
export interface DocumentsV1ReposDocumentsCreateRequest {
    repoId: string;
    tenantRef: string;
    document: Omit<Document, 'id'|'author_name'|'repo_name'|'folder_path'|'latest_version_id'|'latest_version_file_url'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'|'repo'>;
}
...
export interface DocumentsV1ReposDocumentsPartialUpdateRequest {
    ...
    repoId: string;
    tenantRef: string;
    patchedDocument?: Omit<PatchedDocument, 'id'|'author_name'|'repo_name'|'folder_path'|'latest_version_id'|'latest_version_file_url'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'|'repo'>;
}
