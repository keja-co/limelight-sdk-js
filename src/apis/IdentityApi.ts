...
export class IdentityApi extends runtime.BaseAPI {
     ...
     */
    async identityUsersEventsRetrieveRaw(requestParameters: IdentityUsersEventsRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Get upcoming events for user
     */
    async identityUsersEventsRetrieve(requestParameters: IdentityUsersEventsRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.identityUsersEventsRetrieveRaw(requestParameters, initOverrides);
    }
