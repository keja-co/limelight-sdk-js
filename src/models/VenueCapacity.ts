...
export function VenueCapacityToJSONTyped(value?: Omit<VenueCapacity, 'id'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'|'venue'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
