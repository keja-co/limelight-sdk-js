...
export function PatchedReimbursementToJSONTyped(value?: Omit<PatchedReimbursement, 'id'|'payee_name'|'approver_name'|'expense_title'|'expense_is_production'|'production_id'|'production_name'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
