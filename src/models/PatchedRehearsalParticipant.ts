...
export function PatchedRehearsalParticipantToJSONTyped(value?: Omit<PatchedRehearsalParticipant, 'id'|'member_name'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
