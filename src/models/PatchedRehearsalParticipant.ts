...
export function PatchedRehearsalParticipantToJSONTyped(value?: Omit<PatchedRehearsalParticipant, 'id'|'created_at'|'updated_at'|'created_by'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
