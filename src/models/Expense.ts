...
export function instanceOfExpense(value: object): value is Expense {
    ...
    if (!('purchaserName' in value) || value['purchaserName'] === undefined) return false;
    if (!('approverName' in value) || value['approverName'] === undefined) return false;
    ...
    if (!('prodCategoryName' in value) || value['prodCategoryName'] === undefined) return false;
    if (!('productionId' in value) || value['productionId'] === undefined) return false;
    ...
    if (!('reimbursedAmount' in value) || value['reimbursedAmount'] === undefined) return false;
    if (!('pendingReimbursementAmount' in value) || value['pendingReimbursementAmount'] === undefined) return false;
...
export function ExpenseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Expense {
    ...
    return {
        ...
        'reimbursedAmount': json['reimbursed_amount'],
        'pendingReimbursementAmount': json['pending_reimbursement_amount'],
