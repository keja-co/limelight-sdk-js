...
export function DocumentVersionToJSONTyped(value?: Omit<DocumentVersion, 'id'|'created_at'|'updated_at'|'archive_at'|'version'|'tenant'|'created_by'|'updated_by'|'document'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
