...
export function ProductionListToJSONTyped(value?: Omit<ProductionList, 'id'|'venue_name'|'director_name'|'primary_category_name'|'performances_count'|'rehearsals_count'|'members_count'|'next_performance_datetime'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
