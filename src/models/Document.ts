...
export function instanceOfDocument(value: object): value is Document {
    ...
    if (!('latestVersionId' in value) || value['latestVersionId'] === undefined) return false;
    if (!('latestVersionFileUrl' in value) || value['latestVersionFileUrl'] === undefined) return false;
...
export function DocumentFromJSONTyped(json: any, ignoreDiscriminator: boolean): Document {
    ...
    return {
        ...
        'latestVersionFileUrl': json['latest_version_file_url'],
...
export function DocumentToJSONTyped(value?: Omit<Document, 'id'|'author_name'|'repo_name'|'folder_path'|'latest_version_id'|'latest_version_file_url'|'created_at'|'updated_at'|'archive_at'|'tenant'|'created_by'|'updated_by'|'repo'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
