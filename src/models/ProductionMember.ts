...
export function ProductionMemberToJSONTyped(value?: Omit<ProductionMember, 'id'|'created_at'|'updated_at'|'tenant_id'|'created_by'|'updated_by'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
